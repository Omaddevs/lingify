...
function MobileBottomNav() {
  return (
    <nav className="fixed inset-x-4 bottom-4 z-50 rounded-2xl border border-white/80 bg-white/95 p-2 shadow-card backdrop-blur xl:hidden">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex w-full flex-col items-center gap-1 rounded-lg py-2 text-[11px] font-medium transition ${
                  isActive ? 'bg-indigo-100 text-primary' : 'text-slate-500'
                }`
              }
            >
              <Icon size={16} />
